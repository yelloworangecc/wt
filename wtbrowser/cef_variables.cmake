...
if(OS_WINDOWS)
  ...
  # CEF directory paths.
  set(CEF_RESOURCE_DIR        "${_CEF_ROOT}/CefResources")
  set(CEF_BINARY_DIR          "${_CEF_ROOT}/Cef$<CONFIGURATION>")
  set(CEF_BINARY_DIR_DEBUG    "${_CEF_ROOT}/CefDebug")
  set(CEF_BINARY_DIR_RELEASE  "${_CEF_ROOT}/CefRelease")
  ...
  set(CEF_WRAPPER_LIB_DEBUG   "${CEF_BINARY_DIR_DEBUG}/libcef_dll_wrapper.lib")
  set(CEF_WRAPPER_LIB_RELEASE "${CEF_BINARY_DIR_RELEASE}/libcef_dll_wrapper.lib")
